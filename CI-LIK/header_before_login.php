...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow p-3 mb-5" align="center">
        <a class="navbar-brand text-dark nav-custom ml-2" href="depan.php">CILIK</a>
        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="#">Cerita Anak</a>
            ...
            <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                ...
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    <li class="nav-item active nav-custom">
                        <a class="nav-link text-dark reg-btn-custom ml-2 pl-3 pr-3" href="register.php">Register</a>
                    </li>
                </ul>
            </ul>
        </div>
